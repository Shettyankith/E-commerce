...
import SearchBarCard from "../components/SearchBarCard.jsx"
  ...
  return (
    <div className='container mx-auto p-4'>
        ...
        <div className='hidden md:grid grid-cols-[200px,1fr]'>
            {/* Left side */}
            <div className='bg-white p-2 min-h-[calc(100vh-180px)] overflow-y-scroll scroller'>
                {/* Sort By */}
                <div>
            ...
            {/* Right side */}
            <div className='max-h-[calc(100vh-180px)]  overflow-y-scroll scroller'>
              <p className='text-xl font-medium my-2 ml-16'>Search Results:{data.length}</p>
                    { 
                      data.length!==0 && <SearchBarCard data={data} loading={loading}/>
                    }
            </div>
        </div>
    </div>
